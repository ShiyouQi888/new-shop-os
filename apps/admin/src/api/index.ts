...
export const apiConfig = {
  ...
  saveLevelConfig: (config: LevelBenefitConfig) =>
    http.put(`/config/levels/${config.id}`, {
      ...
      resellFeeRate: config.resellFeeRate, consumptionCreditRate: config.consumptionCreditRate,
      consumptionCreditMonths: config.consumptionCreditMonths, consumptionResellable: config.consumptionResellable,
...
export const apiFinance = {
  ...
  getOverview: async () => {
    ...
    return {
      ...
      commissionAvailable: Number(o.commissionAvailable ?? 0),
      commissionSettledPaid: Number(o.commissionPaid ?? 0),
      withdrawPaid: Number(o.withdrawOut ?? 0),
      pendingWithdraw: Number(o.pendingWithdraw ?? 0),
      resellServiceFee: Number(o.serviceFee ?? 0),
      orderCount: Number(o.orderCount ?? 0),
      memberOrderIncome: Number(o.memberOrderIncome ?? 0),
      memberOrderCount: Number(o.memberOrderCount ?? 0),
      giftOrderIncome: Number(o.giftOrderIncome ?? 0),
      giftOrderCount: Number(o.giftOrderCount ?? 0),
      pendingShipAmount: Number(o.pendingShipAmount ?? 0),
      pendingShipCount: Number(o.pendingShipCount ?? 0),
      inTransitAmount: Number(o.inTransitAmount ?? 0),
      inTransitCount: Number(o.inTransitCount ?? 0),
      pendingServiceFee: Number(o.pendingServiceFee ?? 0),
      resellPayout: Number(o.resellPayout ?? 0),
      resellPendingPayout: Number(o.resellPendingPayout ?? 0),
      resellActiveCount: Number(o.resellActiveCount ?? 0),
      resellCompletedCount: Number(o.resellCompletedCount ?? 0),
      walletBalance: Number(o.walletBalance ?? 0),
      walletFrozen: Number(o.walletFrozen ?? 0),
      walletLiability: Number(o.walletLiability ?? 0),
      creditResellableFace: Number(o.creditResellableFace ?? 0),
      creditResellableEstimated: Number(o.creditResellableEstimated ?? 0),
      creditRedeemableLiability: Number(o.creditRedeemableLiability ?? 0),
      resellFeeRate: Number(o.resellFeeRate ?? 0),
      cashIn: Number(o.cashIn ?? 0),
      cashOut: Number(o.cashOut ?? 0),
      fundPoolBalance: Number(o.fundPoolBalance ?? 0),
      cashRiskExposure: Number(o.cashRiskExposure ?? 0),
      fulfillmentExposure: Number(o.fulfillmentExposure ?? 0),
      riskGap: Number(o.riskGap ?? 0),
      coverageRatio: Number(o.coverageRatio ?? 0),
